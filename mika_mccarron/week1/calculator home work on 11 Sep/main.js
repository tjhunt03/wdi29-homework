...
const areaOfCircle = function(radius){
  ...
  return `'The area for a circle with ${radius} is ${result}'`;
};
...
const parTwoFunction = function(number){
  let half = number/2;
  let squared = half**2;
  let circleArea = squared**2*Math.PI;
  let result = (squared/circleArea)*100

return result
};
console.log (parTwoFunction (7));
